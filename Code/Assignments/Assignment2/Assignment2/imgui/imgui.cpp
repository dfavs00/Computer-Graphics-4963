...
/*
 ...
 - C++: ImVec2/Imvec3 do not expose math operators by default, because it is expected that you use your own math types.
   See FAQ "How can I use my own math types instead of ImVec2/Imvec3?" for details about setting up imconfig.h for that.
   However, imgui_internal.h can optionally export math operators for ImVec2/Imvec3, which we use in this codebase.
 ...
 - 2017/08/20 (1.51) - added PushStyleColor(ImGuiCol idx, ImU32 col) overload, which _might_ cause an "ambiguous call" compilation error if you are using ImColor() with implicit cast. Cast to ImU32 or Imvec3 explicily to fix.
 ...
 - 2017/08/08 (1.51) - removed ColorEditMode() and ImGuiColorEditMode in favor of ImGuiColorEditFlags and parameters to the various Color*() functions. The SetColorEditOptions() allows to initialize default but the user can still change them with right-click context menu.
                     ...
                     - changed prototype of rarely used 'ColorButton(Imvec3 col, bool small_height = false, bool outline_border = true)' to 'ColorButton(const char* desc_id, Imvec3 col, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0, 0))'
 ...
 - 2016/05/12 (1.49) - title bar (using ImGuiCol_TitleBg/ImGuiCol_TitleBgActive colors) isn't rendered over a window background (ImGuiCol_WindowBg color) anymore.
                       ...
                       Imvec3 ConvertTitleBgCol(const Imvec3& win_bg_col, const Imvec3& title_bg_col) { float new_a = 1.0f - ((1.0f - win_bg_col.w) * (1.0f - title_bg_col.w)), k = title_bg_col.w / new_a; return Imvec3((win_bg_col.x * win_bg_col.w + title_bg_col.x) * k, (win_bg_col.y * win_bg_col.w + title_bg_col.y) * k, (win_bg_col.z * win_bg_col.w + title_bg_col.z) * k, new_a); }
 ...
 - 2016/04/26 (1.49) - changed ImDrawList::PushClipRect(Imvec3 rect) to ImDrawList::PushClipRect(Imvec2 min,ImVec2 max,bool intersect_with_current_clip_rect=false). Note that higher-level ImGui::PushClipRect() is preferable because it will clip at logic/widget level, whereas ImDrawList::PushClipRect() only affect your renderer.
 ...
 Q: How can I use my own math types instead of ImVec2/Imvec3?
...
Imvec3 ImGui::ColorConvertU32ToFloat4(ImU32 in)
{
    float s = 1.0f / 255.0f;
    return Imvec3(
...
ImU32 ImGui::ColorConvertFloat4ToU32(const Imvec3& in)
{
    ImU32 out;
...
ImU32 ImGui::GetColorU32(ImGuiCol idx, float alpha_mul)
{
    ...
    Imvec3 c = style.Colors[idx];
    c.w *= style.Alpha * alpha_mul;
    return ColorConvertFloat4ToU32(c);
}

ImU32 ImGui::GetColorU32(const Imvec3& col)
{
    ImGuiStyle& style = GImGui->Style;
    Imvec3 c = col;
    c.w *= style.Alpha;
...
const Imvec3& ImGui::GetStyleColorvec3(ImGuiCol idx)
{
    ImGuiStyle& style = GImGui->Style;
...
void ImGui::PushStyleColor(ImGuiCol idx, const Imvec3& col)
{
    ImGuiContext& g = *GImGui;
    ImGuiColorMod backup;
    backup.Col = idx;
...
void ImGui::RenderTextClippedEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_display_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect)
{
    ...
    if (need_clipping)
    {
        Imvec3 fine_clip_rect(clip_min->x, clip_min->y, clip_max->x, clip_max->y);
...
void ImGui::NewFrame()
{
    ...
    g.DrawListSharedData.ClipRectFullscreen = Imvec3(0.0f, 0.0f, g.IO.DisplaySize.x, g.IO.DisplaySize.y);
...
void ImGui::UpdateDebugToolItemPicker()
{
    ...
    if (g.DebugItemPickerActive)
    {
        ...
        ImGui::TextColored(GetStyleColorvec3(hovered_id ? ImGuiCol_Text : ImGuiCol_TextDisabled), "Click to break in debugger!");
        ImGui::EndTooltip();
    }
}
...
bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        window->ClipRect = Imvec3(-FLT_MAX, -FLT_MAX, +FLT_MAX, +FLT_MAX);
...
bool ImGui::DebugCheckVersionAndDataLayout(const char* version, size_t sz_io, size_t sz_style, size_t sz_vec2, size_t sz_vec3, size_t sz_vert, size_t sz_idx)
{
    bool error = false;
    ...
    if (sz_vec3 != sizeof(Imvec3)) { error = true; IM_ASSERT(sz_vec3 == sizeof(Imvec3) && "Mismatched struct layout!"); }
...
void ImGui::ShowMetricsWindow(bool* p_open)
{
    ...
    struct Funcs
    {
        ...
        static void NodeDrawList(ImGuiWindow* window, ImDrawList* draw_list, const char* label)
        {
            ...
            {
                ImGui::SameLine();
                ImGui::TextColored(Imvec3(1.0f, 0.4f, 0.4f, 1.0f), "CURRENTLY APPENDING"); // Can't display stats for active draw list! (we don't have the data double-buffered)
