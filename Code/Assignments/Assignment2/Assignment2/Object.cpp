...
public: 
	...
	Object(int vBuff, int tBuff, int oIndex, int numVert) { 
		position = glm::vec3(0); rotation = glm::vec3(0); scale = glm::vec3(0);
...
public:
	void addChildObject(Object* o) { collection.push_back(o); }
	void removeLastChild() { collection.pop_back(); }
